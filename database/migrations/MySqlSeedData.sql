...
---------------------------------------------------------
-- PERSONS (no PersonId provided – auto_increment)
---------------------------------------------------------
insert into Persons 
...
---------------------------------------------------------
-- GAMES (no GameId provided – auto_increment)
---------------------------------------------------------
...
---------------------------------------------------------
-- PROFILES (uses PersonId + GameId FK)
-- Let’s assume the auto IDs increment from 1 upward.
---------------------------------------------------------
...
---------------------------------------------------------
-- PLAYER ROLES (composite PK: ProfileId + GameId + PlayerRole)
-- Look up matching ProfileId order above:
-- ProfileIds assigned by auto_increment:
--   1 → (Person 1, Game 1)
--   2 → (Person 1, Game 4)
--   3 → (Person 2, Game 3)
--   4 → (Person 3, Game 6)
...
---------------------------------------------------------
-- FRIENDSHIPS (canonicalized; PersonId1 < PersonId2 enforced by check)
---------------------------------------------------------
